    ...
    services: [
      {
        ...
        action: '출생 후 1개월 이내 출생신고서와 출생증명서 제출',
      ...
      },
      {
        ...
        action: '출생신고 후 신청 가능한 출산지원 항목을 선택해 통합신청',
        result: '첫만남이용권은 시·군·구 출산지원 담당부서, 부모급여는 영아복지 담당부서, 아동수당은 아동수당 담당부서로 각각 전달',
        status: '신청'
      },
      {
        name: '첫만남이용권',
        agency: '출생아 주민등록 주소지 관할 시·군·구 출산지원 담당부서',
        channel: '읍·면·동 행정복지센터, 복지로 또는 행복출산 원스톱서비스',
        action: '보호자가 사회보장급여 신청서와 국민행복카드 지급정보 제출',
        result: '대상 결정 후 국민행복카드에 출생아별 이용권 지급',
        status: '신청'
      },
      {
        name: '부모급여',
        agency: '출생아 주민등록 주소지 관할 시·군·구 영아복지 담당부서',
        channel: '읍·면·동 행정복지센터, 복지로 또는 행복출산 원스톱서비스',
        action: '보호자가 지급계좌와 어린이집·종일제 아이돌봄 이용 여부를 포함해 신청',
        result: '0세 월 100만 원, 1세 월 50만 원을 현금 또는 보육·돌봄 바우처로 지급',
        status: '신청'
      },
      {
        name: '아동수당',
        agency: '출생아 주민등록 주소지 관할 시·군·구 아동수당 담당부서',
        channel: '읍·면·동 행정복지센터, 복지로 또는 행복출산 원스톱서비스',
        action: '보호자가 아동과 보호자 정보·지급계좌를 제출해 신청',
        result: '2026년 기준 만 9세 미만 아동에게 지역별 월 10만~13만 원 지급',
        status: '신청'
      }
    ],
    steps: [
