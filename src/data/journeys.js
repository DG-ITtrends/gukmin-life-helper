...
export const journeys = [
  {
    slug: 'birth', icon: '01', title: '아이가 태어났어요', category: '가족·돌봄', summary: '출생신고부터 건강보험, 아동 지원과 돌봄 신청까지 한 번에 살펴봅니다.',
    asOf: '2026-07-12', agencies: ['시·군·구', '국민건강보험공단', '복지로'], keywords: ['출생', '아동수당', '부모급여'],
    services: [service('출생신고', '시·군·구', '신청'), service('행복출산 원스톱서비스', '정부24·주민센터', '연계'), service('건강보험 피부양자·자격 확인', '국민건강보험공단'), service('아동·양육 지원 확인', '복지로')],
    steps: [step(1, '부모', '출생 사실과 신고기한 확인', '출생증명서'), step(2, '시·군·구', '출생신고 접수 및 가족관계 등록', '가족관계등록'), step(3, '관계기관', '자격정보 연계·지원 신청', '신청 결과'), step(4, '부모', '누락 서비스와 돌봄 계획 확인', '개인별 체크리스트')],
    documents: ['출생증명서', '신분증', '급여 수령계좌 등 서비스별 추가정보'], reuseCandidates: ['가족관계', '주민등록', '건강보험 자격'], friction: ['지원별 신청 창구와 시점이 달라 누락 가능성이 있음'], aiOpportunities: ['출생일·가구정보 기반 맞춤 서비스 묶음 제안', '제출정보 자동 점검'],
    sources: [source('정부24 행복출산 원스톱서비스', 'https://www.gov.kr/portal/onestopSvc/happyBirth'), source('복지로', 'https://www.bokjiro.go.kr/')], disclaimer: '지원 금액과 요건은 출생일·소득·지자체에 따라 달라질 수 있습니다.'
  },
  {
